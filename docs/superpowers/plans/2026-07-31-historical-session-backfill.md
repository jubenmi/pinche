...
- apps/api/migrations/0033_historical_session_backfill.sql: durable purpose column and public-list index.
...
**Files:**
- Create: apps/api/migrations/0033_historical_session_backfill.sql
...
- [ ] **Step 5: Commit**
    ...
    git add apps/api/migrations/0033_historical_session_backfill.sql apps/api/test/historical-session-migration.test.mjs
