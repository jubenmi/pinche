...
| 小程序上传版本号规则 | 已确认 | 使用 `0.YYYYMMDD.N`；`YYYYMMDD` 为北京时间当天日期，`N` 为当天第几次成功上传，从 `1` 开始；不得使用 `0.1.0` 或未核对线上版本号的临时版本号 |
| 小程序当前源码版本号 | 已确认：`0.20260629.1` | 对应 2026-06-29 第 1 次按日期序列提交；`versionCode` 为 `2026062901` |
