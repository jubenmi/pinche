...
test("all required provider permission, quota, CAM, policy, and billing alerts retain high priority", () => {
  ...
  const cases = [
    ...
    ["tencent_ci_video", "album_video", "CIRoleNotExist", "tencent_video_cam"],
    ["tencent_ci_video", "album_video", "AccessDenied", "tencent_video_cam"],
    ["tencent_ci_video", "album_video", "InvalidArgument", "tencent_video_policy"],
